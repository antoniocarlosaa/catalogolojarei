                    ...
                    <div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full bg-surface-light border border-white/5 text-white text-xs px-5 py-4 rounded-xl focus:border-gold outline-none font-mono tracking-widest text-center uppercase"
                          placeholder={isZeroKm ? "Opcional" : "ABC"}
                        />
                      </div>
                    </div>
                  </div>
